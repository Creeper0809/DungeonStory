...
| 생산·시설 | `BuildingSO` | 400 | [열기](types/production-facilities/building/README.md) | [CSV](fields/production-facilities/building.csv) | [CSV](relations/production-facilities/building.csv) | [CSV](incoming/production-facilities/building.csv) | [CSV](code-consumers/production-facilities/building.csv) |
...
| 인물·특성 | `CharacterAcquiredTraitModuleSO` | 8 | [열기](types/characters-traits/character-acquired-trait-module/README.md) | [CSV](fields/characters-traits/character-acquired-trait-module.csv) | [CSV](relations/characters-traits/character-acquired-trait-module.csv) | [CSV](incoming/characters-traits/character-acquired-trait-module.csv) | [CSV](code-consumers/characters-traits/character-acquired-trait-module.csv) |
| 인물·특성 | `CharacterAcquiredTraitSettingsSO` | 1 | [열기](types/characters-traits/character-acquired-trait-settings/README.md) | [CSV](fields/characters-traits/character-acquired-trait-settings.csv) | [CSV](relations/characters-traits/character-acquired-trait-settings.csv) | [CSV](incoming/characters-traits/character-acquired-trait-settings.csv) | [CSV](code-consumers/characters-traits/character-acquired-trait-settings.csv) |
...
| 인물·특성 | `CharacterSO` | 16 | [열기](types/characters-traits/character/README.md) | [CSV](fields/characters-traits/character.csv) | [CSV](relations/characters-traits/character.csv) | [CSV](incoming/characters-traits/character.csv) | [CSV](code-consumers/characters-traits/character.csv) |
| 인물·특성 | `CharacterSpeciesSO` | 11 | [열기](types/characters-traits/character-species/README.md) | [CSV](fields/characters-traits/character-species.csv) | [CSV](relations/characters-traits/character-species.csv) | [CSV](incoming/characters-traits/character-species.csv) | [CSV](code-consumers/characters-traits/character-species.csv) |
...
| 사건·캠페인 | `FactionContractDefinitionSO` | 24 | [열기](types/events-campaign/faction-contract/README.md) | [CSV](fields/events-campaign/faction-contract.csv) | [CSV](relations/events-campaign/faction-contract.csv) | [CSV](incoming/events-campaign/faction-contract.csv) | [CSV](code-consumers/events-campaign/faction-contract.csv) |
...
| 인물·특성 | `FuneralCultureSO` | 11 | [열기](types/characters-traits/funeral-culture/README.md) | [CSV](fields/characters-traits/funeral-culture.csv) | [CSV](relations/characters-traits/funeral-culture.csv) | [CSV](incoming/characters-traits/funeral-culture.csv) | [CSV](code-consumers/characters-traits/funeral-culture.csv) |
...
| 연구·효과 | `GameplayEffectDefinitionSO` | 65 | [열기](types/research-effects/gameplay-effect/README.md) | [CSV](fields/research-effects/gameplay-effect.csv) | [CSV](relations/research-effects/gameplay-effect.csv) | [CSV](incoming/research-effects/gameplay-effect.csv) | [CSV](code-consumers/research-effects/gameplay-effect.csv) |
| 아이템 | `GenericItemDefinitionSO` | 703 | [열기](types/items/generic-item/README.md) | [CSV](fields/items/generic-item.csv) | [CSV](relations/items/generic-item.csv) | [CSV](incoming/items/generic-item.csv) | [CSV](code-consumers/items/generic-item.csv) |
...
| 전투·건강·세계 | `OffenseDecisionCardSO` | 54 | [열기](types/combat-health-world/offense-decision-card/README.md) | [CSV](fields/combat-health-world/offense-decision-card.csv) | [CSV](relations/combat-health-world/offense-decision-card.csv) | [CSV](incoming/combat-health-world/offense-decision-card.csv) | [CSV](code-consumers/combat-health-world/offense-decision-card.csv) |
...
| 생산·시설 | `ProductionRecipeSO` | 367 | [열기](types/production-facilities/production-recipe/README.md) | [CSV](fields/production-facilities/production-recipe.csv) | [CSV](relations/production-facilities/production-recipe.csv) | [CSV](incoming/production-facilities/production-recipe.csv) | [CSV](code-consumers/production-facilities/production-recipe.csv) |
...
| 아이템 | `ResourceItemDefinitionSO` | 366 | [열기](types/items/resource-item/README.md) | [CSV](fields/items/resource-item.csv) | [CSV](relations/items/resource-item.csv) | [CSV](incoming/items/resource-item.csv) | [CSV](code-consumers/items/resource-item.csv) |
