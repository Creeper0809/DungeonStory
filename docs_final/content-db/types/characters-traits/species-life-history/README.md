...
- [유형별 콘텐츠 CSV](../../../csv/characters-traits/species-life-history.csv)
- [중첩 작성 필드 CSV](../../../fields/characters-traits/species-life-history.csv)
- [정방향 관계 CSV](../../../relations/characters-traits/species-life-history.csv)
- [역방향 관계 CSV](../../../incoming/characters-traits/species-life-history.csv)

| 안정 ID | 이름 | 전략적 역할 | 비용·위험 | 런타임 상태 | 수명주기 | 역참조 | 구현 권위 |
|---|---|---|---|---|---|---:|---|
| `life-history:adventurer` | Life_Adventurer | 인물·특성 영역의 SpeciesLifeHistorySO 규칙을 분리해 재사용한다. | 작성 자산에서 직접 비용·위험 수치를 확인할 수 없음 | catalog-registered-static-consumer | active-authored | 1 | [Life_Adventurer.asset](../../../../../Assets/Resources/SO/Population/Life/Life_Adventurer.asset) |
| `life-history:beastkin` | Life_Beastkin | 인물·특성 영역의 SpeciesLifeHistorySO 규칙을 분리해 재사용한다. | 작성 자산에서 직접 비용·위험 수치를 확인할 수 없음 | catalog-registered-static-consumer | active-authored | 1 | [Life_Beastkin.asset](../../../../../Assets/Resources/SO/Population/Life/Life_Beastkin.asset) |
...
| `life-history:slime` | Life_Slime | 인물·특성 영역의 SpeciesLifeHistorySO 규칙을 분리해 재사용한다. | 작성 자산에서 직접 비용·위험 수치를 확인할 수 없음 | catalog-registered-static-consumer | active-authored | 1 | [Life_Slime.asset](../../../../../Assets/Resources/SO/Population/Life/Life_Slime.asset) |
| `life-history:vampire` | Life_Vampire | 인물·특성 영역의 SpeciesLifeHistorySO 규칙을 분리해 재사용한다. | 작성 자산에서 직접 비용·위험 수치를 확인할 수 없음 | catalog-registered-static-consumer | active-authored | 1 | [Life_Vampire.asset](../../../../../Assets/Resources/SO/Population/Life/Life_Vampire.asset) |
