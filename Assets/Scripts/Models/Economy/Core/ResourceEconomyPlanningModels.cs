...
public interface IResourceStockPolicyRuntime
{
    ...
    void Restore(DungeonResourceStockPolicySaveData saveData);
}
...
public interface IRegionalSupplyContractRuntime
{
    ...
    void Restore(DungeonRegionalSupplyContractSaveData saveData);
}
...
public interface IGrandProjectRuntime
{
    ...
    void Restore(DungeonGrandProjectSaveData saveData);
}
