...
public sealed class BuildingAbilityListDrawer : PropertyDrawer
{
    ...
    public static IReadOnlyList<Type> AddableTypes => AbilityTypes;
    ...
    public static bool AddAbility(UnityEngine.Object target, string propertyPath, Type abilityType)
    {
    ...
    public static bool RemoveSelected(SerializedProperty listProperty, int index)
    {
    ...
    public static string GetDisplayName(Type abilityType)
    {
