...
public sealed class ResearchGraphLayoutService : IResearchGraphLayoutService
{
    ...
    public ResearchGraphLayout Build(IReadOnlyList<IResearchProjectDefinition> projects)
    {
        ResearchProjectSO[] nodes = (projects ?? Array.Empty<IResearchProjectDefinition>())
            .OfType<ResearchProjectSO>()
