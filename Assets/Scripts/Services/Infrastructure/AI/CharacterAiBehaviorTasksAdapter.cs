...
namespace BehaviorDesigner.Runtime.Tasks.DungeonStory
{
    ...
    [TaskCategory("DungeonStory/Character AI")]
    public sealed class DrinkJobGiverBranch : CharacterJobGiverBranchBase
    {
        protected override CharacterAiBranch Branch => CharacterAiBranch.Drink;
    }
    ...
    public sealed class AmbientIdleJobGiverBranch : Sequence
    {
        ...
        public override float GetUtility()
        {
            ...
            actor.Blackboard?.RecordJobGiverUtility(
                ...
                global::DungeonStory.AI.CharacterAiBehaviorTasks.AmbientIdleUtility,
                "No higher utility job giver selected.");
            return global::DungeonStory.AI.CharacterAiBehaviorTasks.GetAmbientIdleUtility(
                actor.CanRunAi);
        }
    }
    ...
    [TaskCategory("DungeonStory/Character AI")]
    public sealed class SelectDrinkAction : SelectCharacterActionBase
    {
        protected override CharacterAiBranch Branch => CharacterAiBranch.Drink;
    }
