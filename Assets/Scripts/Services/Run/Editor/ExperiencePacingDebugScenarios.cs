...
public static class ExperiencePacingDebugScenarios
{
    ...
    public static void Run()
    {
        ...
        Debug.Log(
            "long-horizon learning rhythm contracts passed: 168 visible research definitions, "
    ...
    private static void CheckResearchContracts(ICollection<string> failures)
    {
        ...
        ResearchProjectSO[] projects = AssetDatabase
            ...
            .ToArray();
        Require(projects.Length == 168, $"expected 168 research projects, got {projects.Length}", failures);
        Require(
