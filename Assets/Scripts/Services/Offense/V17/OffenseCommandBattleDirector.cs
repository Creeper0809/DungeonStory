...
public interface IOffenseBattleDirector
{
    ...
    void Restore(OffenseBattleDirectorStateData state);
    void Clear();
}
...
public sealed class OffenseBattleDirector : IOffenseBattleDirector
{
    ...
    private readonly Dictionary<string, OffenseFormationPosition> formations =
    ...
    public void Restore(OffenseBattleDirectorStateData state)
    {
        if (state == null
        ...
        {
            throw new InvalidOperationException("Invalid V17 offense battle state.");
        }
