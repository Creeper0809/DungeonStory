...
public static class OffenseV17DebugScenarios
{
    [MenuItem("Tools/DungeonStory/Validation/Run Offense V17 Scenarios")]
    ...
    public static string RunAll()
    {
        ...
        Run("V17 중간 상태 저장 왕복", VerifySaveRoundTrip, passed);
        ...
        return $"Offense V17 scenarios passed ({passed.Count}): "
            + string.Join(", ", passed);
    }
    ...
    private static void VerifyDecisionEffects()
    {
        ...
        OffenseReturnSafetyRuntime safety = new OffenseReturnSafetyRuntime(world);
        OffenseTravelRuntime travel = new OffenseTravelRuntime(world, safety);
        Require(
    ...
    private static void VerifyCommandBattle()
    {
        ...
        IReadOnlyList<OffenseCommandCardStateData> generatedCards =
            OffenseV17BattleSetupFactory.CreateMemberDecks(deckSession)[0].cards;
        Require(
    ...
    private static void VerifySaveRoundTrip()
    {
            ...
            new CapturingPreparationService(new[]
            {
                new OffenseSupplyPackingStateData
                {
                    ...
                    costs = new List<OffenseSupplyPackingItemStateData>
                    {
                        ...
                        {
                            itemId = "stock-item:Food",
                            amount = 4
                        },
                        new OffenseSupplyPackingItemStateData
                        {
                            itemId = "stock-item:Medicine",
                            amount = 2
                        }
                    }
                }
        ...
        OffenseV17SaveSection sourceSection = new OffenseV17SaveSection(
            world,
            travel,
            safety,
            decisions,
            ...
            mitigation,
            preparation,
            new EmptyExpeditionRuntimeProvider());
        string sourceJson = sourceSection.Capture();
        ...
        OffenseTravelRuntime restoredTravel =
            new OffenseTravelRuntime(restoredWorld, restoredSafety);
        ...
        OffenseBattleDirector restoredBattle =
            new OffenseBattleDirector(new RecordingResolutionAdapter());
        CapturingMitigationRuntime restoredMitigation =
            new CapturingMitigationRuntime();
        CapturingPreparationService restoredPreparation =
            new CapturingPreparationService();
        OffenseV17SaveSection restoredSection = new OffenseV17SaveSection(
            restoredWorld,
            restoredTravel,
            restoredSafety,
            restoredDecisions,
        ...
        Require(
            ...
            "V17 중간 상태가 저장 후 동일하게 복원되지 않았습니다.");
        Require(
    ...
    private sealed class EmptyExpeditionRuntimeProvider :
    ...
    private sealed class EmptyRunVariableProvider : IRunVariableRuntimeProvider
    {
        ...
        IFacilityEvolutionWarehouseInventoryQuery
    {
        ...
        {
            return Array.Empty<WarehouseInventory>();
        }
    }
    ...
    private sealed class EditorContentCatalog : IOffenseV17ContentCatalog
    {
