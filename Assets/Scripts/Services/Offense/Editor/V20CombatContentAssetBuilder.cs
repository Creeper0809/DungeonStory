...
public static class V20CombatContentAssetBuilder
{
    ...
    private static readonly EnemySpec[] Enemies=
    {
        ...
        E("enemy:settler-barricadier","자유개척 바리케이드병","임시 방벽 뒤에서 약한 동료를 지킨다.","human:settler","Human",EnemyCombatRole.Defender,"scattered-cover","weapon:spear","armor:gambeson","",102,7,10,6,4,new[]{"enemy-ability:shield-wall"},new[]{"counter:destroy-cover"}),
        ...
        E("enemy:neutral-clockwork","유랑 태엽구성체","가장 가까운 장치를 보호하고 손상 시 수리한다.","neutral:construct","Golem",EnemyCombatRole.Defender,"device-guard","weapon:warhammer","armor:breastplate","",148,10,14,6,3.5f,new[]{"enemy-ability:shield-wall","enemy-ability:core-repair"},new[]{"counter:precision"}),
