...
public static class V20CombatContentAssetBuilder
{
    ...
    private static OffenseEncounterSO CreateEncounter(EncounterSpec spec,IReadOnlyList<EnemyArchetypeDefinitionSO> enemies,IReadOnlyList<BattlefieldModifierDefinitionSO> modifiers)
    {
        ...
        CombatEncounterCalibration calibration=CombatBalanceCheckpointAuthority.RequireEncounter(spec.Index);
        ...
        v.displayName=spec.Name;v.minimumSiteStrength=Mathf.Max(1,(spec.Index-1)/4+1);v.maximumSiteStrength=v.minimumSiteStrength+3;v.elite=spec.Elite;v.boss=spec.Boss;v.enemyHealthMultiplier=calibration.EnemyHealthMultiplier;v.enemyDamageMultiplier=calibration.EnemyDamageMultiplier;v.enemyAccuracyMultiplier=calibration.EnemyAccuracyMultiplier;v.objectiveHealthMultiplier=calibration.ObjectiveHealthMultiplier;v.objectiveControlResistanceMultiplier=calibration.ObjectiveControlResistanceMultiplier;v.additionalEnemyCount=calibration.AdditionalEnemyCount;
        v.objective=spec.Objective;v.objectiveRoundLimit=spec.Objective==OffenseEncounterObjective.DefeatAll?0:calibration.ObjectiveRoundLimit;v.objectiveTargetId=spec.ObjectiveTargetId??string.Empty;
