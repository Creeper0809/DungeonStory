...
public static class DomainFailureLocalizationAssetBuilder
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["ApparelAttachmentMissing"] = "The required apparel attachment is missing.",
            ["ApparelBodyFormIncompatible"] = "The apparel is incompatible with this body form.",
            ["ApparelCharacterMissing"] = "The apparel character is unavailable.",
            ["ApparelDefinitionMissing"] = "The apparel definition is missing.",
            ["ApparelFacilityUnavailable"] = "The required apparel facility is unavailable.",
            ["ApparelItemReserved"] = "The apparel item is already reserved.",
            ["ApparelLayerOccupied"] = "The apparel layer is already occupied.",
            ["ApparelMaterialUnavailable"] = "The required apparel material is unavailable.",
            ["ApparelModificationRequired"] = "The apparel requires modification before use.",
            ["ApparelPhysicalItemMissing"] = "The physical apparel item is missing.",
            ["ApparelPlanStale"] = "The apparel work plan is stale.",
            ["ApparelRecoveryDeferred"] = "Apparel recovery has been deferred.",
            ["ApparelResearchLocked"] = "The apparel is locked by research.",
            ["ApparelReservationExpired"] = "The apparel reservation has expired.",
            ["ApparelSizeIncompatible"] = "The apparel size is incompatible.",
            ["ApparelStateInvalid"] = "The apparel state is invalid.",
            ["ApparelTransferFailed"] = "The apparel transfer failed.",
            ["ApparelWorkOrderInvalid"] = "The apparel work order is invalid.",
            ["QualityPipelineBlocked"] = "The quality pipeline is blocked.",
            ["QualityTargetUnreachable"] = "The requested quality target cannot be reached.",
            ["WorkOrderInvalid"] = "The work order is invalid.",
            ["WorkOrderMissing"] = "The work order is missing.",
            ["WorkOrderWorkerIneligible"] = "The selected worker is not eligible for this work order.",
["AlreadyProcessed"] = "Already processed.",
            ...
            ["ItemReservationRequestInvalid"] = "The item quantity reservation request is invalid. Operation: {0}",
            ["ItemReservationStackMissing"] = "The reserved item stack is missing. Stack: {0}",
            ["ItemReservationStackForbidden"] = "The item stack is forbidden. Stack: {0}",
            ["ItemReservationSignatureMismatch"] = "The item stack signature changed. Stack: {0}",
            ["ItemReservationQuantityUnavailable"] = "The requested item quantity is unavailable. Target: {0}",
            ["ItemReservationOperationConflict"] = "The reservation operation conflicts with an existing claim. Operation: {0}",
            ["ItemReservationLeaseMissing"] = "The item quantity lease is missing. Lease: {0}",
            ["ItemReservationLeaseExpired"] = "The item quantity lease expired. Lease: {0}",
            ["ItemReservationSliceInvalid"] = "The reserved item slice is invalid. Lease: {0}, stack: {1}",
            ["ItemReservationRestoreConflict"] = "Saved item ownership cannot be restored. Owner or stack: {0}, detail: {1}",
            ["WarehouseMassAdmissionRequestInvalid"] = "The warehouse mass admission request is invalid. Operation or token: {0}, detail: {1}",
            ["WarehouseMassAdmissionOwnerUnavailable"] = "The warehouse mass admission owner is unavailable or incompatible. Warehouse: {0}, category: {1}",
            ["WarehouseMassCapacityUnavailable"] = "The warehouse has insufficient mass capacity. Warehouse: {0}, item: {1}, remaining grams: {2}",
            ["WarehouseMassAdmissionTokenMissing"] = "The warehouse mass admission token is missing. Token: {0}",
            ["WarehouseMassAdmissionTokenExpired"] = "The warehouse mass admission token expired. Token: {0}, status: {1}",
            ["WarehouseMassAdmissionRevisionMismatch"] = "The warehouse mass admission revision changed. Warehouse or token: {0}, expected: {1}, actual: {2}",
            ["WarehouseMassAdmissionFingerprintMismatch"] = "The warehouse mass admission lot fingerprint changed. Operation: {0}, fingerprint: {1}",
            ["WarehouseMassAdmissionCommitConflict"] = "The warehouse mass admission token was committed with a different commit ID. Token: {0}, commit: {1}",
            ["WarehouseMassAdmissionTokenTerminal"] = "The warehouse mass admission token is already terminal. Token: {0}, status: {1}",
            ["ItemAggregationIncompatible"] = "The carried stack is incompatible with this buffer aggregation cohort. Item: {0}",
            ["ItemAggregationDestinationMissing"] = "The buffer aggregation destination is missing. Destination: {0}",
    ...
    private static readonly IReadOnlyDictionary<string, string> Korean =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["ApparelAttachmentMissing"] = "필수 의복 부착물이 없습니다.",
            ["ApparelBodyFormIncompatible"] = "이 의복은 해당 체형과 호환되지 않습니다.",
            ["ApparelCharacterMissing"] = "의복 대상 캐릭터를 찾을 수 없습니다.",
            ["ApparelDefinitionMissing"] = "의복 정의가 없습니다.",
            ["ApparelFacilityUnavailable"] = "필요한 의복 시설을 사용할 수 없습니다.",
            ["ApparelItemReserved"] = "의복 아이템이 이미 예약되어 있습니다.",
            ["ApparelLayerOccupied"] = "의복 착용 부위가 이미 사용 중입니다.",
            ["ApparelMaterialUnavailable"] = "필요한 의복 재료가 없습니다.",
            ["ApparelModificationRequired"] = "착용 전에 의복 개조가 필요합니다.",
            ["ApparelPhysicalItemMissing"] = "물리 의복 아이템이 없습니다.",
            ["ApparelPlanStale"] = "의복 작업 계획이 오래되었습니다.",
            ["ApparelRecoveryDeferred"] = "의복 회수가 보류되었습니다.",
            ["ApparelResearchLocked"] = "연구가 완료되지 않아 의복을 사용할 수 없습니다.",
            ["ApparelReservationExpired"] = "의복 예약이 만료되었습니다.",
            ["ApparelSizeIncompatible"] = "의복 크기가 맞지 않습니다.",
            ["ApparelStateInvalid"] = "의복 상태가 올바르지 않습니다.",
            ["ApparelTransferFailed"] = "의복 이전에 실패했습니다.",
            ["ApparelWorkOrderInvalid"] = "의복 작업 명령이 올바르지 않습니다.",
            ["QualityPipelineBlocked"] = "품질 처리 단계가 차단되었습니다.",
            ["QualityTargetUnreachable"] = "요청한 품질 목표에 도달할 수 없습니다.",
            ["WorkOrderInvalid"] = "작업 명령이 올바르지 않습니다.",
            ["WorkOrderMissing"] = "작업 명령을 찾을 수 없습니다.",
            ["WorkOrderWorkerIneligible"] = "선택한 작업자는 이 작업 명령을 수행할 수 없습니다.",
...
["AlreadyProcessed"] = "이미 처리된 소모품 사용입니다.",
            ...
            ["ItemReservationRequestInvalid"] = "아이템 수량 예약 요청이 올바르지 않습니다. 작업: {0}",
            ["ItemReservationStackMissing"] = "예약 대상 아이템 묶음이 없습니다. 묶음: {0}",
            ["ItemReservationStackForbidden"] = "사용 금지된 아이템 묶음입니다. 묶음: {0}",
            ["ItemReservationSignatureMismatch"] = "아이템 묶음 구성이 변경되었습니다. 묶음: {0}",
            ["ItemReservationQuantityUnavailable"] = "요청한 아이템 수량을 사용할 수 없습니다. 대상: {0}",
            ["ItemReservationOperationConflict"] = "예약 작업이 기존 점유권과 충돌합니다. 작업: {0}",
            ["ItemReservationLeaseMissing"] = "아이템 수량 임대가 없습니다. 임대: {0}",
            ["ItemReservationLeaseExpired"] = "아이템 수량 임대가 만료되었습니다. 임대: {0}",
            ["ItemReservationSliceInvalid"] = "예약된 아이템 조각이 올바르지 않습니다. 임대: {0}, 묶음: {1}",
            ["ItemReservationRestoreConflict"] = "저장된 아이템 점유권을 복원할 수 없습니다. 소유자 또는 묶음: {0}, 상세: {1}",
            ["WarehouseMassAdmissionRequestInvalid"] = "창고 질량 입고 요청이 올바르지 않습니다. 작업 또는 토큰: {0}, 상세: {1}",
            ["WarehouseMassAdmissionOwnerUnavailable"] = "창고 질량 입고 소유자를 사용할 수 없거나 분류가 맞지 않습니다. 창고: {0}, 분류: {1}",
            ["WarehouseMassCapacityUnavailable"] = "창고의 질량 용량이 부족합니다. 창고: {0}, 아이템: {1}, 남은 그램: {2}",
            ["WarehouseMassAdmissionTokenMissing"] = "창고 질량 입고 토큰을 찾을 수 없습니다. 토큰: {0}",
            ["WarehouseMassAdmissionTokenExpired"] = "창고 질량 입고 토큰이 만료되었습니다. 토큰: {0}, 상태: {1}",
            ["WarehouseMassAdmissionRevisionMismatch"] = "창고 질량 입고 중 권위 리비전이 변경되었습니다. 창고 또는 토큰: {0}, 예상: {1}, 실제: {2}",
            ["WarehouseMassAdmissionFingerprintMismatch"] = "창고 질량 입고 대상 묶음의 지문이 변경되었습니다. 작업: {0}, 지문: {1}",
            ["WarehouseMassAdmissionCommitConflict"] = "창고 질량 입고 토큰이 다른 커밋 ID로 이미 확정되었습니다. 토큰: {0}, 커밋: {1}",
            ["WarehouseMassAdmissionTokenTerminal"] = "창고 질량 입고 토큰이 이미 종료 상태입니다. 토큰: {0}, 상태: {1}",
            ["ItemAggregationIncompatible"] = "운반 아이템 묶음을 이 버퍼 집약 그룹과 합칠 수 없습니다. 아이템: {0}",
            ["ItemAggregationDestinationMissing"] = "버퍼 집약 목적지가 없습니다. 목적지: {0}",
