...
public static class V20EcologyContentAssetBuilder
{
    ...
    private sealed class WildlifeSpec{public string Id,Name,Description,Nest,Migration,Disease;public WildlifeDietType Diet;public WildlifeHabitatType[] Habitats;public WildlifeMigrationProfile MigrationProfile;public WildlifeCompanionRoleProfile CompanionRoleProfile;public WildlifeHaulRoleProfile HaulRoleProfile;public float Aggression,ProductComfortMinimumTemperatureC,ProductComfortMaximumTemperatureC;public bool Domesticable;public string[] Prey,Predators;public Season Breed;public Season[] Active;}
    ...
    {
        W("glow_moth","발광나방","마나 빛을 따라 이동하며 버섯 포자를 옮기는 작은 계절 곤충.",WildlifeDietType.Herbivore,new[]{WildlifeHabitatType.Brush,WildlifeHabitatType.Lair},.05f,false,new string[0],new[]{"cave_rat","silk_spider"},"nest:ceiling-cocoon",Season.Spring,"migration:mana-lamp","disease:mana-pox",new[]{Season.Spring,Season.Summer},WildlifeMigrationProfile.LoreOnly()),
        W("ash_crawler","재먼지 기는벌레","재 더미를 먹고 환기구에 군집해 재먼지폐를 퍼뜨린다.",WildlifeDietType.Scavenger,new[]{WildlifeHabitatType.Burrow,WildlifeHabitatType.Lair},.2f,false,new string[0],new[]{"ember_lizard","cave_hound"},"nest:ash-vent",Season.Summer,"migration:heat-duct","disease:ash-lung",new[]{Season.Summer,Season.Autumn},WildlifeMigrationProfile.LoreOnly()),
        W("deep_goat","심층염소","절벽 이끼를 먹고 길들일 수 있어 털과 운반 노동을 제공한다.",WildlifeDietType.Herbivore,new[]{WildlifeHabitatType.Grass,WildlifeHabitatType.Lair},.15f,true,new string[0],new[]{"shadow_wolf","cave_hound"},"nest:stone-ledge",Season.Spring,"migration:vertical-graze","disease:deep-parasitosis",new[]{Season.Spring,Season.Summer,Season.Autumn},WildlifeMigrationProfile.GeneralHabitat(),haulRoleProfile:new WildlifeHaulRoleProfile(18000L,.8f,.5f)),
        W("crystal_beetle","수정딱정벌레","마나 결정 가루를 먹고 단단한 갑각을 남기는 군집 곤충.",WildlifeDietType.Omnivore,new[]{WildlifeHabitatType.Burrow,WildlifeHabitatType.Lair},.1f,true,new string[0],new[]{"moss_boar","ember_lizard"},"nest:crystal-crevice",Season.Winter,"migration:mana-vein","disease:glass-blood",new[]{Season.Autumn,Season.Winter},WildlifeMigrationProfile.LoreOnly()),
        W("tunnel_mole","굴착두더지","뿌리 작물을 해치지만 길들인 개체는 얕은 광맥을 찾는다.",WildlifeDietType.Herbivore,new[]{WildlifeHabitatType.Burrow,WildlifeHabitatType.Grass},.1f,true,new string[0],new[]{"cave_hound","shadow_wolf"},"nest:root-burrow",Season.Spring,"migration:soft-soil","disease:deep-parasitosis",new[]{Season.Spring,Season.Autumn},WildlifeMigrationProfile.LoreOnly()),
        W("carrion_drake","시체청소 비룡","전장과 도살장의 사체를 찾아오며 병원체를 먼 거리로 옮긴다.",WildlifeDietType.Scavenger,new[]{WildlifeHabitatType.Lair,WildlifeHabitatType.Brush},.8f,false,new[]{"cave_rat","shadow_hare"},new string[0],"nest:high-bone-pile",Season.Autumn,"migration:battlefield-scent","disease:gut-rot",new[]{Season.Autumn,Season.Winter},WildlifeMigrationProfile.Carcass()),
        W("mire_leech","진흙거머리","오염된 물에서 번식해 가축과 직원을 흡혈한다.",WildlifeDietType.Carnivore,new[]{WildlifeHabitatType.Water},.45f,false,new[]{"rune_deer","deep_goat"},new[]{"spore_elk"},"nest:mud-clutch",Season.Summer,"migration:flood-channel","disease:blood-wasting",new[]{Season.Spring,Season.Summer},WildlifeMigrationProfile.FoulWater()),
        W("frost_ram","서리숫양","겨울에 활동하는 대형 초식동물로 길들이면 털과 운반력을 제공한다.",WildlifeDietType.Herbivore,new[]{WildlifeHabitatType.Grass,WildlifeHabitatType.Lair},.55f,true,new string[0],new[]{"shadow_wolf"},"nest:frost-alcove",Season.Winter,"migration:cold-front","disease:cave-flu",new[]{Season.Winter,Season.Spring},WildlifeMigrationProfile.TemperatureBand(-10f,10f),-10f,10f,haulRoleProfile:new WildlifeHaulRoleProfile(24000L,.75f,.5f)),
        W("ember_lizard","잿불도마뱀","뜨거운 배관 주변 해충을 먹지만 잿불열을 매개한다.",WildlifeDietType.Carnivore,new[]{WildlifeHabitatType.Lair,WildlifeHabitatType.Burrow},.35f,true,new[]{"ash_crawler","crystal_beetle"},new[]{"cave_hound"},"nest:warm-pipe",Season.Summer,"migration:heat-source","disease:ember-fever",new[]{Season.Summer,Season.Autumn},WildlifeMigrationProfile.TemperatureBand(20f,35f),20f,35f),
        W("spore_elk","포자큰사슴","균사 정원의 포자를 멀리 퍼뜨리는 대형 초식동물.",WildlifeDietType.Herbivore,new[]{WildlifeHabitatType.Grass,WildlifeHabitatType.Brush},.25f,true,new string[0],new[]{"shadow_wolf","mire_leech"},"nest:mycelial-grove",Season.Autumn,"migration:spore-bloom","disease:white-spore",new[]{Season.Spring,Season.Autumn},WildlifeMigrationProfile.LoreOnly()),
        W("mana_wisp","마나도깨비불","전력망 누출을 따라 모이며 다른 비전 생물을 끌어들인다.",WildlifeDietType.Omnivore,new[]{WildlifeHabitatType.Lair,WildlifeHabitatType.Water},.05f,false,new string[0],new[]{"rune_deer"},"nest:rune-node",Season.Winter,"migration:power-flux","disease:mana-pox",new[]{Season.Summer,Season.Winter},WildlifeMigrationProfile.LoreOnly()),
        W("cave_hound","동굴사냥개","무리 사냥을 하며 길들이면 정착지 직원 곁을 지키고 교전에 동행한다.",WildlifeDietType.Carnivore,new[]{WildlifeHabitatType.Lair,WildlifeHabitatType.Brush},.7f,true,new[]{"cave_rat","shadow_hare","tunnel_mole"},new[]{"carrion_drake"},"nest:pack-den",Season.Spring,"migration:prey-trail","disease:red-fever",new[]{Season.Spring,Season.Summer,Season.Autumn,Season.Winter},WildlifeMigrationProfile.GeneralHabitat(),companionRoleProfile:WildlifeCompanionRoleProfile.OwnerCompanion()),
        W("silk_spider","동굴명주거미","발광나방을 잡고 채집 가능한 질긴 거미줄을 만든다.",WildlifeDietType.Carnivore,new[]{WildlifeHabitatType.Lair,WildlifeHabitatType.Brush},.3f,true,new[]{"glow_moth","cave_rat"},new[]{"cave_hound"},"nest:silk-web",Season.Autumn,"migration:insect-swarm","disease:dream-mold",new[]{Season.Spring,Season.Autumn},WildlifeMigrationProfile.GeneralHabitat())
    };
    ...
    public static void Build()
    {
        ...
        // The ecology rebuild recreates crystal_beetle from NewWildlife. Reapply
        // WIM030 through its narrow existing authoring path so the regular
        // build preserves both the cataloged carapace and its butcher yield.
        Wim030CrystalBeetleCarapaceAssetBuilder.Publish();
    ...
    private static WildlifeSpeciesSO CreateWildlife(WildlifeSpec s){WildlifeSpeciesSO v=Asset<WildlifeSpeciesSO>($"{WildlifeRoot}/wildlife_{s.Id}.asset");v.ConfigureV20(s.Id,s.Name,s.Description,s.Diet,s.Habitats,s.Aggression,s.Domesticable,s.Prey,s.Predators,s.Nest,s.Breed,s.Migration,new[]{s.Disease},s.Active);v.ConfigureMigrationProfile(s.MigrationProfile);v.ConfigureCompanionRoleProfile(s.CompanionRoleProfile);v.ConfigureHaulRoleProfile(s.HaulRoleProfile);if(s.Domesticable)v.ConfigureProductTemperatureComfort(s.ProductComfortMinimumTemperatureC,s.ProductComfortMaximumTemperatureC);Dirty(v);return v;}
    private static void UpgradeExistingWildlife(WildlifeSpeciesSO v){string prey=v.SpeciesId=="shadow_wolf"?"shadow_hare":"cave_rat";string predator=v.SpeciesId=="shadow_wolf"?"carrion_drake":"shadow_wolf";v.ConfigureV20(v.SpeciesId,v.DisplayName,v.Description,v.Diet,v.PreferredHabitats.Count>0?v.PreferredHabitats:new[]{WildlifeHabitatType.Grass},v.Aggression,v.Husbandry.Domesticable,new[]{prey},new[]{predator},$"nest:{v.SpeciesId}",Season.Spring,$"migration:{v.SpeciesId}",new[]{"disease:cave-flu"},new[]{Season.Spring,Season.Summer,Season.Autumn});v.ConfigureMigrationProfile(WildlifeMigrationProfile.GeneralHabitat());v.ConfigureCompanionRoleProfile(null);v.ConfigureProductTemperatureComfort(5f,30f);Dirty(v);}
    ...
    private static WildlifeSpec W(string id,string name,string description,WildlifeDietType diet,WildlifeHabitatType[] habitats,float aggression,bool domesticable,string[] prey,string[] predators,string nest,Season breed,string migration,string disease,Season[] active,WildlifeMigrationProfile migrationProfile,float productComfortMinimumTemperatureC=5f,float productComfortMaximumTemperatureC=30f,WildlifeCompanionRoleProfile companionRoleProfile=null,WildlifeHaulRoleProfile haulRoleProfile=null)=>new(){Id=id,Name=name,Description=description,Diet=diet,Habitats=habitats,Aggression=aggression,Domesticable=domesticable,Prey=prey,Predators=predators,Nest=nest,Breed=breed,Migration=migration,Disease=disease,Active=active,MigrationProfile=migrationProfile,CompanionRoleProfile=companionRoleProfile,HaulRoleProfile=haulRoleProfile,ProductComfortMinimumTemperatureC=productComfortMinimumTemperatureC,ProductComfortMaximumTemperatureC=productComfortMaximumTemperatureC};
