...
public enum FailureCode
{
    ...
    ApparelCharacterMissing,
    ApparelDefinitionMissing,
    ApparelPhysicalItemMissing,
    ApparelStateInvalid,
    ApparelBodyFormIncompatible,
    ApparelAttachmentMissing,
    ApparelSizeIncompatible,
    ApparelModificationRequired,
    ApparelLayerOccupied,
    ApparelItemReserved,
    ApparelResearchLocked,
    ApparelTransferFailed,
    ApparelPlanStale,
    ApparelRecoveryDeferred,
    ApparelMaterialUnavailable,
    ApparelWorkOrderInvalid,
    ApparelFacilityUnavailable,
    ApparelReservationExpired,
    WorkOrderMissing,
    WorkOrderInvalid,
    WorkOrderWorkerIneligible,
    ...
    ItemReservationRequestInvalid,
    ItemReservationStackMissing,
    ItemReservationSignatureMismatch,
    ItemReservationStackForbidden,
    ItemReservationQuantityUnavailable,
    ItemReservationOperationConflict,
    ItemReservationLeaseMissing,
    ItemReservationLeaseExpired,
    ItemReservationSliceInvalid,
    ItemReservationRestoreConflict,
    WarehouseMassAdmissionRequestInvalid,
    WarehouseMassAdmissionOwnerUnavailable,
    WarehouseMassCapacityUnavailable,
    WarehouseMassAdmissionTokenMissing,
    WarehouseMassAdmissionTokenExpired,
    WarehouseMassAdmissionRevisionMismatch,
    WarehouseMassAdmissionFingerprintMismatch,
    WarehouseMassAdmissionCommitConflict,
    WarehouseMassAdmissionTokenTerminal,
    ItemAggregationIncompatible,
    ItemAggregationDestinationMissing,
    WastePolicyInvalid,
