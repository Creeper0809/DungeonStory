...
public static class DefenseUiLocalizationAssetBuilder
{
    ...
    private static readonly Entry[] Entries =
    {
        ...
        E("CommittedWarningUnknown", "침입 정보: 미상", "Invasion information: unknown"),
        E("CommittedWarningUnknownValue", "미상", "Unknown"),
        E("CommittedWarningDetail", "침입 정보 / 입구 {0} / 접근 {1}\n{2} / 적 성격 {3}\n작전 {4} / 작전 목표 {5} / 실제 표적 {6}", "Invasion information / Entry {0} / Approach {1}\n{2} / Enemy nature {3}\nOperation {4} / Operation objective {5} / Actual target {6}"),
        E("CommittedWarningRallyEstimate", "집결 종료/진입 시도 예상 {0}초", "Rally end / entry attempt estimate {0}s"),
        E("CommittedWarningEntering", "진입 중", "Entering"),
        E("CommittedWarningEntered", "진입 완료 / 실제 단계 {0}", "Entry completed / Actual phase {0}"),
        E("CommittedWarningActualPhase", "실제 단계 {0}", "Actual phase {0}"),
        E("CommittedWarningDirection.Unknown", "미상", "Unknown"),
        E("CommittedWarningDirection.East", "동쪽", "East"),
        E("CommittedWarningDirection.West", "서쪽", "West"),
        E("CommittedWarningDirection.North", "북쪽", "North"),
        E("CommittedWarningDirection.South", "남쪽", "South"),
