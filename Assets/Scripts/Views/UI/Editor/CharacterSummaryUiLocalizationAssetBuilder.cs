...
public static class CharacterSummaryUiLocalizationAssetBuilder
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Korean =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["CharacterSummary.Detailed.Tab.BaseStats"] = "숙련 효과",
            ["CharacterSummary.Detailed.Tab.Work"] = "작업",
            ["CharacterSummary.Detailed.Tab.Proficiencies"] = "숙련",
            ...
            ["CharacterSummary.Combat.Quality.Mythic"] = "신화",
            ...
            ["CharacterSummary.Health.Consumables.ToxicityRow"] = "독성 부담  {0:0.#} / 100 · 작업/전투 -{1:0.#}% · {2}",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Available"] = "해독제 치료 가능",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Pending"] = "해독 치료 처리 중",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.NotNeeded"] = "해독 치료 불필요",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Unauthored"] = "유효한 해독제가 정의되지 않음",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Unavailable"] = "해독제 재고 없음",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.Row"] = "치료 물자 · {0} · {1}",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.Kind.Standard"] = "일반 치료",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.Kind.Detox"] = "해독 치료",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.Ready"] = "약품 도착",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.Requested"] = "배송 요청됨",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.InTransit"] = "배송 중",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.StockMissing"] = "약품 재고 없음",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.CapacityUnavailable"] = "진료소 보관 공간 부족",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.NoPath"] = "최근 배송 경로 없음",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.Processing"] = "약품 사용 후 처리 중",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.AwaitingRequest"] = "약품 배송 필요",
            ...
            ["CharacterSummary.Health.Button.MealQuality"] = "식사 상한: {0}",
            ["CharacterSummary.Health.MealQuality.Inherit"] = "기본(고급)",
            ["CharacterSummary.Health.MealQuality.Poor"] = "조악",
            ["CharacterSummary.Health.MealQuality.Simple"] = "소박",
            ["CharacterSummary.Health.MealQuality.Decent"] = "양호",
            ["CharacterSummary.Health.MealQuality.Fine"] = "고급",
            ["CharacterSummary.Health.MealQuality.Lavish"] = "호화",
            ...
            ["CharacterSummary.Status.LightAdaptation.Row"] = "밝기 적응 · 현재 {0:0.#} / 적정 {1:0.#}–{2:0.#} · 불편 {3:0}% · 기분 {4:+0.#;-0.#;0} · 작업 {5:+0.#;-0.#;0}%"
        };
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["CharacterSummary.Detailed.Tab.BaseStats"] = "Proficiency effects",
            ["CharacterSummary.Detailed.Tab.Work"] = "Work",
            ["CharacterSummary.Detailed.Tab.Proficiencies"] = "Proficiencies",
            ...
            ["CharacterSummary.Combat.Quality.Mythic"] = "Mythic",
            ...
            ["CharacterSummary.Health.Consumables.ToxicityRow"] = "Toxicity  {0:0.#} / 100 · work/combat -{1:0.#}% · {2}",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Available"] = "antidote treatment available",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Pending"] = "detox treatment pending",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.NotNeeded"] = "detox treatment not needed",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Unauthored"] = "no valid antidote is authored",
            ["CharacterSummary.Health.Consumables.ToxicityTreatment.Unavailable"] = "antidote stock unavailable",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.Row"] = "Treatment supplies · {0} · {1}",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.Kind.Standard"] = "standard treatment",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.Kind.Detox"] = "detox treatment",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.Ready"] = "medicine arrived",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.Requested"] = "delivery requested",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.InTransit"] = "delivery in transit",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.StockMissing"] = "medicine stock unavailable",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.CapacityUnavailable"] = "clinic buffer capacity unavailable",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.NoPath"] = "last delivery attempt had no path",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.Processing"] = "processing consumed medicine",
            ["CharacterSummary.Health.Consumables.TreatmentSupply.State.AwaitingRequest"] = "medicine delivery required",
            ...
            ["CharacterSummary.Health.Button.MealQuality"] = "Meal cap: {0}",
            ["CharacterSummary.Health.MealQuality.Inherit"] = "Default (fine)",
            ["CharacterSummary.Health.MealQuality.Poor"] = "Poor",
            ["CharacterSummary.Health.MealQuality.Simple"] = "Simple",
            ["CharacterSummary.Health.MealQuality.Decent"] = "Decent",
            ["CharacterSummary.Health.MealQuality.Fine"] = "Fine",
            ["CharacterSummary.Health.MealQuality.Lavish"] = "Lavish",
            ...
            ["CharacterSummary.Status.LightAdaptation.Row"] = "Light adaptation · current {0:0.#} / comfort {1:0.#}–{2:0.#} · discomfort {3:0}% · mood {4:+0.#;-0.#;0} · work {5:+0.#;-0.#;0}%"
        };
