...
public static class EventAlertUiFactory
{
        ...
        ITmpKoreanFontService tmpKoreanFontService)
    {
        ...
        Image image = buttonObject.GetComponent<Image>();
        image.color = DungeonUiThemePalette.Accent(highContrast: false);
    ...
    private static Color GetImportanceColor(EventAlertImportance importance)
    {
        return importance switch
        {
            ...
            EventAlertImportance.Medium => Color.Lerp(
                DungeonUiThemePalette.SurfaceRaised(highContrast: false),
                DungeonUiThemePalette.Warning(highContrast: false),
                0.55f),
            EventAlertImportance.High => Color.Lerp(
                DungeonUiThemePalette.SurfaceRaised(highContrast: false),
                DungeonUiThemePalette.Danger(highContrast: false),
                0.65f),
            _ => DungeonUiThemePalette.SurfaceRaised(highContrast: false)
        };
    }
}
