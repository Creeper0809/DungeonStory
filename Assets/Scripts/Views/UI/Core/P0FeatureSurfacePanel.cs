...
public sealed partial class P0FeatureSurfacePanel : MonoBehaviour, IFeatureSurfaceView
{
    ...
    private void EnsureLayout()
    {
        ...
        scrollBackground.color = DungeonUiThemePalette.SurfaceMuted(false);
        ...
        float height)
    {
        ...
        image.color = DungeonUiThemePalette.Surface(false);
        ...
        titleText.color = DungeonUiThemePalette.TextPrimary(false);
        ...
        detailText.color = DungeonUiThemePalette.TextSecondary(false);
        ...
        FeatureSurfaceStepper stepper)
    {
        ...
        TMP_Text label = AddText(
            ...
            14f,
            FontStyles.Bold);
        label.color = DungeonUiThemePalette.TextSecondary(false);
    ...
    private void AddSection(string title, string summary)
    {
        ...
        image.color = DungeonUiThemePalette.SurfaceRaised(false);
        image.raycastTarget = false;
        ...
        titleText.color = DungeonUiThemePalette.Warning(false);
        TMP_Text summaryText = AddText(section.transform, summary, 15f, FontStyles.Normal);
        summaryText.color = DungeonUiThemePalette.TextSecondary(false);
    ...
    private void AddFeedback()
    {
        ...
        feedbackText.color = DungeonUiThemePalette.Warning(false);
        ...
        float height)
    {
        ...
        image.color = DungeonUiThemePalette.Accent(false);
